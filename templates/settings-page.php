...
<div class="wrap agent-hub-dashboard">
    ...
    <div id="tab-analytics" class="tab-content">
        ...
        <div class="agent-economy-hero">
            <div class="economy-badge">
                <span class="dashicons dashicons-chart-area"></span>
                <span>x402 Agent Economy</span>
            </div>
        ...
        <div class="user-position-grid">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-label">Your Total Links</div>
                    <div class="stat-value" id="stat-total-links">0</div>
                    <div class="stat-context">Protected Pages</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value" id="stat-user-revenue">$0.00</div>
                    <div class="stat-context">USDC Earned</div>
                </div>
            </div>
            ...
            <div class="stat-card stat-card-highlight">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value" id="stat-market-share">0.0000%</div>
                    <div class="stat-context" id="stat-rank-info">of Total Ecosystem</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value" id="stat-ecosystem-tx">0</div>
                    <div class="stat-context">Across All Publishers</div>
                </div>
            </div>
        </div>

        <!-- Motivational Banner -->
        <div id="motivation-banner" class="motivation-banner" style="display:none;"></div>

        <!-- Facilitators Section -->
        <div class="facilitators-section">
            <h3><span class="dashicons dashicons-networking"></span> Top Facilitators</h3>
            <div id="facilitator-bars" class="facilitator-bars">
                <div class="facilitator-loading">
                    <span class="spinner is-active"></span> Loading facilitator data...
                </div>
            </div>
        </div>
