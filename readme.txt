...
= 2.3.4 =
* Added comprehensive diagnostic logging for wallet sync troubleshooting
* Enhanced logging in AJAX handler, API request method, and edge function
* Improved error tracking to identify wallet sync failures
